...
<section class="contact-section">
    ...
    <div class="contact-content">
        ...
        <p>If you would like to get in touch, please reach out to me through any of the following methods:</p>
        <ul>
            <li><strong>Email:</strong> simasiku@example.com</li>
